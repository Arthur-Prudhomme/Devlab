...
<header class="z-20 flex fixed top-0 w-screen flex-row bg-fond text-gris h-20">
    <div class="w-11/12 flex flex-row justify-between mx-auto">
        ...
        <div class="w-1/2 flex flex-row justify-between items-center">
            <a href="home.php" class="cursor-pointer underline underline-offset-8">Home</a>
            <a href="AllGenre.php" class="cursor-pointer">Genre</a>
            <a href="topRated.php?page=1" class="cursor-pointer">Top Rated </a>
            <a href="trending.php?page=1" class="cursor-pointer">Trending</a>
            <a class="appear cursor-pointer">Login</a>
            <form method="post">
