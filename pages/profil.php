...
?>
  ...
  <main class="flex flex-col lg:mt-32 mt-20">
    <div class="w-11/12 mx-auto flex flex-col">
      <?php 
        echo '<h1 class="uppercase font-bold mt-8 lg:mt-0 text-2xl lg:text-3xl mb-8">Hello ' . $_SESSION['user']['username'] . '</h1>';
      ?>
      <div class="flex lg:flex-row flex-col">
        <div class="flex flex-col lg:w-1/2 w-11/12 mx-auto">
          <?php 
            echo '<h2 class="uppercase font-semi-bold mt-8 lg:mt-0 text-lg lg:text-xl">Your Albums</h2>';
            echo '<a class="mt-4" href="albums.php"><img class="rounded-lg lg:w-1/2 w-full" src=' . $api->getImg($movie['poster_path'], 500) . '></a><br>';
          ?>
        </div>
        <div class="flex flex-col lg:w-1/2 w-11/12 mx-auto">
          <?php
            echo '<h2 class="uppercase font-semi-bold mt-8 lg:mt-0 text-lg lg:text-xl">Liked Albums</h2>';
